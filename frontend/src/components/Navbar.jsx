    ...
    return (
        <header className="absolute top-[-2px] left-0 w-full h-[50px] flex items-center px-8">
            ...
            <nav className="flex gap-10">
                ...
                <a href="/community" className="text-navy text-[20px] font-normal px-4 py-1">
                    Community
                </a>
                <a href="/consultation" className="text-navy text-[20px] font-normal px-4 py-1">
                    Consultation
                </a>
                <a href="/chatbot" className="text-navy text-[20px] font-normal px-4 py-1">
                    Chatbot
                </a>
            </nav>
